...
public class BlockBreakListener implements Listener {
    ...
    public void onBlockBreak(final BlockBreakEvent event) {
        ...
        GravityTubesFile.getInstance().getTubes().stream().filter(gravityTube -> gravityTube.getLocation().equals(event.getBlock().getLocation())).findFirst().ifPresent(gravityTube -> {
